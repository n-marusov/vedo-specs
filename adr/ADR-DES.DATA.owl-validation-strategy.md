...
**Оптимизации:**
1. **Early exit:** Прерывание при обнаружении первой блокирующей ошибки
2. **Кэширование:** TTL 5 минут для неизменённых онтологий
...
2. **Задержка:** Early exit при критической ошибке, кэширование, асинхронность для больших онтологий.
